...
// IO access
#define CONTROLBYTE_IORQ_RD         B11110110
#define CONTROLBYTE_IORQ_WR         B11110101

// Z80 FUJI OPERATIONS
// ROMCS Memory access (Z80 or ESP under BUSRQ)
#define CONTROLBYTE_CEROMRQ_RD      B10100110
#define CONTROLBYTE_CEROMRQ_WR      B10100101

// RIOconfig (ESP under BUSRQ ONLY)
#define CONTROLBYTE_RIOCONFIG_RD    B11100010
#define CONTROLBYTE_RIOCONFIG_WR    B11100001
